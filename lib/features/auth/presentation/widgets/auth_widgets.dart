...
/// ViKus wordmark used on the auth screens.
class VikusLogo extends StatelessWidget {
  const VikusLogo({super.key, this.fontSize = 34});
...
/// Branded gradient header with the ViKus logo, a tagline and decorative pins.
/// Replaces the photographic header from the mockup (no bundled asset).
class VikusAuthHeader extends StatelessWidget {
  const VikusAuthHeader({super.key, this.height = 200});
      ...
      child: Stack(
        children: [
          DecoratedBox(
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [Color(0xFFF1E9FF), Color(0xFFF7F2FF)],
              ),
          ...
          const Positioned(
            top: 36,
            left: 40,
            child: Icon(Icons.location_on, color: Color(0x33A658FF), size: 30),
          ),
          const Positioned(
            top: 70,
            right: 48,
            child: Icon(Icons.location_on, color: Color(0x33A658FF), size: 22),
          ),
          Center(
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                ...
                Text.rich(
                  const TextSpan(
                    children: [
                      TextSpan(text: 'Conecta con negocios locales '),
                      TextSpan(
                        text: 'cerca de ti',
                        style: TextStyle(
                          color: AppColors.purple,
